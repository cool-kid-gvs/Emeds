...
<head>
  ...
  <title>eMeds Doctors Dashboard</title>
          ...
          <div class="row">
              <section class="col-lg-6 connectedSortable">
                  <div class="box box-success">
                      <div class="box-header">
                          <h3 class="box-title">Current Waitlist</h3>
                      ...
                      <div class="box-body">
                            <div class="box">
                                <div class="box-body">
                                    <?php genWaitlistDoc($_SESSION['arr_details']['doc_id']); ?>
                                </div>
                            </div>
                      </div>
                  </div>
              ...
              <section class="col-lg-6 connectedSortable">
                <div class="box box-info">
                    ...
                    <div class="box">
                        <div class="box-body">
                            <?php genPresListDoc($_SESSION['arr_details']['doc_id']); ?>
                        </div>
                    </div>
                </div>
              </section>
