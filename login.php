...
<div class="login-box">
  ...
  <?php
				if ( isset($_POST[ 'submit' ]) == "1") {
					login( $_POST[ 'user' ], $_POST[ 'pass' ] , $_POST[ 'type' ]);
				}
				?>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="POST">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit" value="1">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="#" onclick="alert('Not available in prototype');">I forgot my password</a><br>
